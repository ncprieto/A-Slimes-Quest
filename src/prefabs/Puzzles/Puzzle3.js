class Puzzle3 extends Room{
    ...
    makePuzzle1(doorPosArr){
        ...
        this.piece1 = this.physics.add.sprite(this.piece1Obj.path[1], this.piece1Obj.path[0], 'wallTile').setOrigin(0, 0).setScale(this.wallScale).setBounce(0);
        this.piece2Obj = {
        ...
        this.piece2 = this.physics.add.sprite(this.piece2Obj.path[2], this.piece2Obj.path[0], 'wallTile').setOrigin(0, 0).setScale(this.wallScale).setBounce(0);
        this.piece3Obj = {
            path: [450, 300, 900],
            target: [300, 450]
        }
        ...
        this.piece4 = this.physics.add.sprite(this.piece4Obj.path[2], this.piece4Obj.path[0], 'wallTile').setOrigin(0, 0).setScale(this.wallScale).setBounce(0);
