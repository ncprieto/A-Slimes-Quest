class Puzzle1 extends Room{
    ...
    makePuzzle1(doorPosArr){
        ...
        this.piece2 = this.physics.add.sprite(this.piece2Obj.path[1], this.piece2Obj.path[0], 'wallTile').setOrigin(0, 0).setScale(this.wallScale).setBounce(0);
        this.piece3Obj = {
        ...
        this.piece3 = this.physics.add.sprite(this.piece3Obj.path[1], this.piece3Obj.path[0], 'wallTile').setOrigin(0, 0).setScale(this.wallScale).setBounce(0);
